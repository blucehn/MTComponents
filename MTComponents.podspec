#
# Be sure to run `pod lib lint MTComponents.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MTComponents'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MTComponents.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'MTComponents/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MTComponents' => ['MTComponents/Assets/*.png']
  # }
